...
_PICKER_STRINGS = {
    "en": {
        ...
        "picker_capture_add": "Add clipboard image",
        "picker_capture_saved": "Capture saved.",
        "picker_capture_duplicate": "This capture is already saved.",
        "picker_capture_no_image": "No image is available in the clipboard.",
        "picker_capture_read_error": "Couldn't read the clipboard. Try again.",
        "picker_capture_register_error": "Couldn't save the capture.",
        "picker_capture_collection": "Captures",
        "picker_auto_capture": "Automatically save new clipboard images",
        "picker_auto_capture_note": "Off by default. Copied image files are excluded.",
        "notify_capture_save_fail": "Couldn't automatically save the clipboard image.",
        "picker_settings_title": "Picker settings",
        "picker_folders_subtitle": "Watched folders",
        "picker_drop_partial": "Added {count}; {failed} failed.",
        "picker_drop_failed": "No files could be added.",
    ...
    "ko": {
        ...
        "picker_capture_add": "클립보드 이미지 추가",
        "picker_capture_saved": "캡처를 저장했습니다.",
        "picker_capture_duplicate": "이미 저장된 캡처입니다.",
        "picker_capture_no_image": "클립보드에 저장할 이미지가 없습니다.",
        "picker_capture_read_error": "클립보드를 읽지 못했습니다. 다시 시도하세요.",
        "picker_capture_register_error": "캡처를 저장하지 못했습니다.",
        "picker_capture_collection": "캡처",
        "picker_auto_capture": "새 클립보드 이미지 자동 저장",
        "picker_auto_capture_note": "기본적으로 꺼져 있습니다. 복사한 이미지 파일은 제외됩니다.",
        "notify_capture_save_fail": "클립보드 이미지를 자동 저장하지 못했습니다.",
        "picker_settings_title": "피커 설정",
        "picker_folders_subtitle": "감시 폴더",
        "picker_drop_partial": "{count}개 추가, {failed}개 실패했습니다.",
        "picker_drop_failed": "파일을 추가하지 못했습니다.",
        "picker_search": "검색",
    ...
    "ja": {
        ...
        "picker_capture_add": "クリップボード画像を追加",
        "picker_capture_saved": "キャプチャを保存しました。",
        "picker_capture_duplicate": "このキャプチャは保存済みです。",
        "picker_capture_no_image": "クリップボードに画像がありません。",
        "picker_capture_read_error": "クリップボードを読み取れませんでした。再試行してください。",
        "picker_capture_register_error": "キャプチャを保存できませんでした。",
        "picker_capture_collection": "キャプチャ",
        "picker_auto_capture": "新しいクリップボード画像を自動保存",
        "picker_auto_capture_note": "初期設定はオフです。コピーした画像ファイルは除外されます。",
        "notify_capture_save_fail": "クリップボード画像を自動保存できませんでした。",
        "picker_settings_title": "ピッカー設定",
        "picker_folders_subtitle": "監視フォルダー",
        "picker_drop_partial": "{count}件追加、{failed}件失敗しました。",
        "picker_drop_failed": "ファイルを追加できませんでした。",
        "picker_search": "検索",
    ...
    "zh": {
        ...
        "picker_capture_add": "添加剪贴板图片",
        "picker_capture_saved": "已保存截图。",
        "picker_capture_duplicate": "此截图已保存。",
        "picker_capture_no_image": "剪贴板中没有可保存的图片。",
        "picker_capture_read_error": "无法读取剪贴板，请重试。",
        "picker_capture_register_error": "无法保存截图。",
        "picker_capture_collection": "截图",
        "picker_auto_capture": "自动保存新的剪贴板图片",
        "picker_auto_capture_note": "默认关闭。复制的图片文件不会保存。",
        "notify_capture_save_fail": "无法自动保存剪贴板图片。",
        "picker_settings_title": "选择器设置",
        "picker_folders_subtitle": "监视文件夹",
        "picker_drop_partial": "已添加 {count} 个，{failed} 个失败。",
        "picker_drop_failed": "无法添加文件。",
        "picker_search": "搜索",
        "picker_tab_emoji": "表情",
    ...
    "es": {
        ...
        "picker_capture_add": "Añadir imagen del portapapeles",
        "picker_capture_saved": "Captura guardada.",
        "picker_capture_duplicate": "Esta captura ya está guardada.",
        "picker_capture_no_image": "No hay ninguna imagen en el portapapeles.",
        "picker_capture_read_error": "No se pudo leer el portapapeles. Inténtalo de nuevo.",
        "picker_capture_register_error": "No se pudo guardar la captura.",
        "picker_capture_collection": "Capturas",
        "picker_auto_capture": "Guardar automáticamente imágenes nuevas",
        "picker_auto_capture_note": "Desactivado de forma predeterminada. Se excluyen los archivos de imagen copiados.",
        "notify_capture_save_fail": "No se pudo guardar automáticamente la imagen del portapapeles.",
        "picker_settings_title": "Ajustes del selector",
        "picker_folders_subtitle": "Carpetas vigiladas",
        "picker_drop_partial": "Se añadieron {count}; fallaron {failed}.",
        "picker_drop_failed": "No se pudo añadir ningún archivo.",
